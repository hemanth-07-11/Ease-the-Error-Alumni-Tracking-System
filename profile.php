		...
		<div class="flex justify-between">
			<div class="flex space-x-4">
				<div class="">
					...
					<svg class="h-8 w-8 mr-1 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
						</svg>
					<span class="ml-3 font-bold text-lg">Frequenty chated</span>
					</a>
				</div>
		...
		for($i=0;$i<mysqli_num_rows($result);$i++) {
			if($list[$i]['is_active']==1) {
				echo "				
					...
					<div class='mt-8 lg:ml-16  bg-gray-50 border-2 rounded-xl pb-1 pt-1 lg:w-10/12'>
